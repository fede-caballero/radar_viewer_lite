...
export function RadarVisualization({ inputFiles, predictionFiles, isProcessing: _isProcessing }: RadarVisualizationProps) {
          ...
          <div className="max-w-4xl mx-auto w-full flex flex-col gap-2">
            ...
            <div className="relative h-6 flex items-center group">
              ...
              <Slider
                ...
                onValueChange={(value: number[]) => { setIsPlaying(false); setCurrentFrameIndex(value[0]); }}
